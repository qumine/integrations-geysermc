...
RUN curl -L --output /home/qumine/geysermc.jar https://ci.opencollab.dev/job/GeyserMC/job/Geyser/job/master/956/artifact/bootstrap/standalone/target/Geyser.jar \
